...
const FLEET = [
  ...
  {
    category: "Muscle",
    name: "Challenger R/T · F8 Green",
    year: "2018",
    subtitle: "F8 Green · 5.7L HEMI",
  ...
  {
    category: "Comfort",
    name: "Subaru Legacy Touring XT",
    year: "2022",
    subtitle: "Crimson Red · 2.4L Turbo",
    specs: ["260 hp", "AWD", "28 MPG"],
    price: "$69",
    badge: "LAUNCH PRICING",
    href: "/orlando-subaru-legacy-rental/",
    bookingUrl: "/orlando-subaru-legacy-rental/",
    halfDay: false,
    img: FLEET_IMAGES.legacyHero,
    categoryColor: "#3f6fa8",
  },
  {
    category: "Muscle",
    name: "Challenger R/T · B5 Blue",
    year: "2018",
    subtitle: "B5 Blue · 5.7L HEMI",
    specs: ["372 hp", "5 seats", "RWD"],
    price: "$89",
    badge: "NEW TO FLEET",
    href: "/challenger-rt-b5-rental/",
    bookingUrl: "/challenger-rt-b5-rental/",
    halfDay: true,
    img: FLEET_IMAGES.challengerB5Hero,
    categoryColor: "#2f6fd0",
  },
  {
    category: "Everyday",
    name: "Honda HR-V EX-L",
    year: "2023",
    subtitle: "White · 29 MPG",
    specs: ["158 hp", "5 seats", "Big hatch"],
    price: "$59",
    badge: "BEST VALUE",
    href: "/orlando-hrv-rental/",
    bookingUrl: "/orlando-hrv-rental/",
    halfDay: false,
    img: FLEET_IMAGES.hrvHero,
    categoryColor: "#5b8a8f",
  },
  ];
