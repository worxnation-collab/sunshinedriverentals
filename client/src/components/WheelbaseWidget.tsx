 ...
 * Booking band. Primary action books on Turo (insurance handled there);
 * a "text your dates" option stays as the direct, human fallback.
 */
...
export default function WheelbaseWidget({ vehicleName, id = "book", turoUrl }: WheelbaseWidgetProps) {
      ...
      <div className="container">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.6rem, 3vw, 2rem)", fontWeight: 800, marginBottom: "0.75rem", color: "var(--sd-charcoal)" }}>
            Book the {vehicleName}
          </h2>
          <p style={{ color: "var(--sd-muted)", fontSize: "0.9rem", marginBottom: "2rem", lineHeight: 1.6 }}>
            Reserve instantly on Turo — insurance included, real-time availability. Prefer to talk dates first? Just text us.
          </p>
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            {turoUrl ? (
              <a href={turoUrl} target="_blank" rel="noopener noreferrer" className="btn-book" style={{ fontSize: "1rem", padding: "0.875rem 2.25rem" }}>Book on Turo</a>
            ) : (
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <span className="text-sm" style={{ color: "var(--sd-muted)" }}><span style={{ color: "var(--sd-green)" }}>✓</span> Local, family-run</span>
          </div>
